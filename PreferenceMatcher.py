...
PLACEMENTS_BY_DIRECTORATE_NAME = {
    ...
    "IT Operations": [
        "14 - Cloud Centre of Excellence (Infrastructure Services)",
    ...
    "Cyber Security": ["34 - CSOC", "39 - Innovation and Delivery"],
    "Assurance and Risk Management": [
        "42 - CPMO Standards & Investment",
